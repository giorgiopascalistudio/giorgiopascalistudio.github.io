...
class JSocNavigationApp {
    constructor() {
        ...
        // Demo waypoints for Puglia region
        this.loadDemoWaypoints();
        ...
        if ('DeviceOrientationEvent' in window) {
            window.addEventListener('deviceorientation', (e) => {
                ...
                if (heading !== null) {
                    ...
                    this.deviceHeading = (360 - heading) % 360;
                    this.updateCompass();
                }
            });
    ...
    addManualWaypoint() {
        ...
        // Validate
        if (!waypoint.name || isNaN(waypoint.easting) || isNaN(waypoint.northing)) {
